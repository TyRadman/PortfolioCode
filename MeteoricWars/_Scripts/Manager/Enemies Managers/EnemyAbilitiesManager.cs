...
namespace SpaceWar
{
    public class EnemyAbilitiesManager : Singlton<EnemyAbilitiesManager>
    {
        ...
        public struct AbilityStyles
        {
            ...
            public List<EnemyAbilityStyle> Styles;
        }
        ...
        //private Dictionary<ShipRank, EnemyAbilityPrefab> m_ShipAbilities = new Dictionary<ShipRank, EnemyAbilityPrefab>();
        ...
        public void AddAbilities(EnemyShipAbilities _ship, ShipRank _rank)
        {
            ...
            if (_ship.Components.Rank == ShipRank.Summoner)
            {
