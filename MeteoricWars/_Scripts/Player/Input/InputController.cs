...
namespace SpaceWar
{
    public class InputController : MonoBehaviour
    {
        ...
        public static InputActionMap GetMap(int player, ActionMap map)
        {
            ...
            InputActionMap selectedMap = m_Maps.Find(m => m.PlayerIndex == player && m.MapTag == map).Map;
        ...
        public void SetUp()
        {
            ...
            //SetUpProfiles(GameManager.i.PlayersManager.Players.Count);
            //SetAbilityDisplayKeys();
        }
        ...
        public void EnableInput(ActionMap actionMap, int playerIndex = -1)
        {
            ...
            //print($"Enabled map is {m_PlayerInputs[playerIndex].currentActionMap.name}");
        }
    }
