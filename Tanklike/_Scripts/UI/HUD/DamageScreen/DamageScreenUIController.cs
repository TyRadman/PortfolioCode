...
namespace TankLike.UI
{
    public class DamageScreenUIController : MonoBehaviour, IManager
    {
        ...
        public void ShowDamageScreen(int playerIndex, bool lowHealth)
        {
            _lowHealthOverlay[playerIndex] = lowHealth;
            ...
            _damageScreenCoroutines[playerIndex] = StartCoroutine(DamageScreenRoutine(playerIndex, lowHealth));
        }
