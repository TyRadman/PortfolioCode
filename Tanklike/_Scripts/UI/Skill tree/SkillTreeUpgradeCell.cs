...
namespace TankLike.Combat.SkillTree
{
    ...
    public class SkillTreeUpgradeCell : UICell, ICellSelectable
    {
        ...
        public string GetName()
        {
            ...
            return OnUnlockedUpgrade.MainInfo.Name;
        }

        public string GetDescription(PlayerComponents player)
        {
            if (OnUnlockedUpgrade == null)
            {
                return string.Empty;
            ...
            string description = OnUnlockedUpgrade.MainInfo.Description;
