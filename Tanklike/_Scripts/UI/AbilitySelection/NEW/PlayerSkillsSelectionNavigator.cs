...
namespace TankLike.Combat.SkillTree
{
    ...
    public class PlayerSkillsSelectionNavigator : Navigatable, IInput
    {
        ...
        public void SetUpInput(int playerIndex)
        {
            ...
            // if the submit action was used to join the lobby and open the menu,
            // we subscribe to the performSelection action only AFTER we release the input
            // this is done to avoid having it take the players to the "Ready" button as soon as they join
            //Debug.Log(submitAction.phase);
            //if (submitAction.phase is InputActionPhase.Performed or InputActionPhase.Started or InputActionPhase.Waiting)
            //{
            //    submitAction.performed += HandleDelayedSubmit;
            //}
            //else
            //{
            //}
        ...
        //private void HandleDelayedSubmit(InputAction.CallbackContext context)
        //{
        //    context.action.performed -= HandleDelayedSubmit;
        //    context.action.performed += PerformSelection;
        //}
        ...
        public override void SetUpActionSignifiers(ISignifierController signifierController)
        {
            ...
            int schemeIndex = GameManager.Instance.InputManager.GetInputScheme(PlayerIndex);
        ...
        private void PerformCancellation(InputAction.CallbackContext context)
        {
            ...
            else if (!_isReady)
            {
                ...
                if (playerInputManager != null)
                {
                    ...
                    //playerInputManager.playerLeftEvent?.Invoke(playerInput);
                }
            }
        }
        #endregion
