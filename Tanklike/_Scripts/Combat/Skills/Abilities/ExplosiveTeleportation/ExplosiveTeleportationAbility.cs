...
namespace TankLike.Combat.Abilities
{
    ...
    public class ExplosiveTeleportationAbility : Ability
    {
        ...
        private Vector3 GetTargetPoint()
        {
            ...
            Vector3 castStartPoint = _components.transform.position - direction * Constants.OffsetToWalls;
            ...
            RaycastHit[] hits = Physics.SphereCastAll(castStartPoint, checkRadius, direction, TeleportDistance + sphereRadius + Constants.OffsetToWalls, _obstacleLayers);
            ...
            if (hits.Length == 1)
            {
                // Now check for obstacles at the mid point using an overlap sphere
